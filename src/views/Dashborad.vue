    ...
    <main>
      <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        ...
        <div class="px-4 py-6 sm:px-0">
          <div
            class="h-96 rounded-lg border-4 border-dashed border-gray-200 p-5"
          >
            <div class="mb-6">
              <label
                for="large-input"
              ...
              <input
                type="text"
                id="large-input" v-model="posts.title"
            ...
            <div class="mb-6">
              ...
              <input
                type="text"
                id="base-input" v-model="posts.body"
            ...
            <div>
              ...
              <input
                type="text"
                id="small-input" v-model="posts.author"
            ...
            <button type="button" v-on:click="addPost()" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 mt-2">حفظ</button>
          </div>
        </div>
        <!-- /End replace -->
      </div>
